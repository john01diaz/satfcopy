...
def get_b_app_runner_standard_exemplar_configuration_oxi() \
    ...
    etl_processes_wrapper_configuration = \
        get_common_local_b_app_runner_standard_exemplar_configuration(
            drive_name='C',
            user_initials='OXi',
            configuration_json_relative_file_path='filtered_gold_io_catalogue_excel_new_silver.json',
            ...
            output_folder_prefix='filtered_gold_io_catalogue_excel_new_silver',
