...
from sat_workflow_source.a_startup.user_specific.jpr.b_app_runner_standard_exemplar_configuration_getter_jpr import \
    get_sat_workflow_b_app_runner_configuration_jpr
