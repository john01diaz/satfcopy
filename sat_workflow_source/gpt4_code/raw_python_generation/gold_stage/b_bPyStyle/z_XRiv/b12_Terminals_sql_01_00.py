...
def _12_Terminals(
	...
	database_names = load_database_names(
		database_names_csv)
	terminals_df = load_terminals(
		terminals_csv)

	filtered_terminals = filter_terminals(
		terminals_df,
		class_filter,
		database_names)

	ranked_terminals = rank_terminals(
		filtered_terminals)
...
if __name__ == "__main__":
	terminals_csv = Path(
		"path/to/your/terminals.csv")
	database_names_csv = Path(
		"path/to/your/database_names.csv")

	result_df = _12_Terminals(
		terminals_csv,
		database_names_csv)
	print(
		result_df)
