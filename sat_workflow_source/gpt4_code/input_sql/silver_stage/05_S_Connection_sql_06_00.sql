...
-- In Sigraph, the IO cards and FTAs are not connected using wire or cable. It is only symbolic representation.
-- Need to Generate the IO connection. The below query will join IO with FTA's
