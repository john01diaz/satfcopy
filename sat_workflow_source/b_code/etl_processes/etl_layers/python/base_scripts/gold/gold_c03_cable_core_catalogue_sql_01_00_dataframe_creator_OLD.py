...
def create_dataframe_gold_c03_cable_core_catalogue_OLD(
        input_tables: dict) -> pandas.DataFrame:
    s_cable_core_catalogue_dataframe = \
        input_tables['Sigraph_Silver.S_CableCoreCatalogue']

    s_cable_catalogue_dataframe = \
        input_tables['Sigraph_Silver.S_CableCatalogue']

    s_cable_catalogue_number_master_dataframe = \
        input_tables['Sigraph_Silver.S_CableCatalogueNumber_Master']
