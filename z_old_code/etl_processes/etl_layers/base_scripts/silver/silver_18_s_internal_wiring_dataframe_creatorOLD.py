...
def create_silver_18_s_internal_wiring_sql_01_00_dataframe(
    ...
    # Filtering
    filtered_s_connection = s_connection_dataframe[
        (s_connection_dataframe[S_CONNECTION_FROM_LOCATION] == s_connection_dataframe[S_CONNECTION_TO_LOCATION]) &
        s_connection_dataframe[S_CONNECTION_FROM_LOCATION].notna() &
        s_connection_dataframe[S_CONNECTION_TO_LOCATION].notna()
        ]
    ...
    silver_18_s_internal_wiring_sql_01_00_dataframe = dataframe_merged.drop_duplicates()
    
    return silver_18_s_internal_wiring_sql_01_00_dataframe
