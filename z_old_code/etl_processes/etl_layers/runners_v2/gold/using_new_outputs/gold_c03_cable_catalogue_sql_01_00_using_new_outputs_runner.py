from z_old_code.etl_processes.etl_layers.runners_v2.gold.gold_c03_cable_catalogue_sql_01_00_runner import \
...
def run_gold_c03_cable_catalogue_sql_01_00_using_new_outputs(
