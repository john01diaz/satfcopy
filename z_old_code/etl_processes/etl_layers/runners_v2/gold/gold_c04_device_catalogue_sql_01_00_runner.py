...
def run_gold_c04_device_catalogue_sql_01_00(
    ...
    etl_processes_wrapper_universe.register_generated_and_index_output_table(
        ...
        identifier_column_names=['type', 'description', 'manufacturer',	'modelno', 'class', 'left',	'right',	'left_marking',	'right_marking',	'symbol_name',	'product_key',	'loop_number',	'tag_number',	'document_number'],
