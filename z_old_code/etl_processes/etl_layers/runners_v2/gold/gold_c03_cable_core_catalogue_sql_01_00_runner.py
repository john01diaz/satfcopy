...
from sat_workflow_source.b_code.etl_processes.etl_layers.python.base_scripts.gold.gold_c03_cable_core_catalogue_sql_01_00_dataframe_creator import create_dataframe_gold_c03_cable_core_catalogue
...
def run_gold_c03_cable_core_catalogue_sql_01_00(
        ...
        s_cablecorecatalogue_source: str = 'input') \
        -> None:
    ...
    cable_core_catalogue_dataframe = \
        etl_processes_wrapper_universe.get_and_index_input_dataframe(
            ...
            table_type=s_cablecorecatalogue_source).table

    database_names_dataframe = \
        create_database_names_view(
            database_string='R_2016R3')

    gold_c03_cable_core_catalogue_dataframe = \
        create_dataframe_gold_c03_cable_core_catalogue(
    ...
    etl_processes_wrapper_universe.register_generated_and_index_output_table(
        table=gold_c03_cable_core_catalogue_dataframe,
