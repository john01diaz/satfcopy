...
if __name__ == '__main__':
    ...
    etl_database_configuration_file_path = \
        os.path.join(
            configurations_folder_path,
            'process_table_configuration v0.02 AGu modified OXi+AMi_CPa_v7_run_processes OXi.accdb')
    ...
    run_b_app(
        ...
        etl_json_configuration_file_name='etl_run_configuration_full_io_catalogue_excel_test.json',
        etl_json_configuration_filtered_file_name='etl_run_configuration_filtered_io_catalogue_excel_test.json')
