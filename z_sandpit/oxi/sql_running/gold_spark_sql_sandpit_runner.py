...
from z_old_code.sql.runners.gold.gold_c06_io_catalogue_sql_01_00_dataframe_from_sql_creator import \
    run_gold_06_io_catalogue_sql_01_00_spark_sql_OLD
from z_old_code.sql.runners.gold.gold_c13_terminations_sql_01_00_dataframe_from_sql_creator import \
...
from sat_workflow_source.b_code.etl_processes_wrapper.objects.helpers.sql_create_table_statement_from_pandas_dataframe_exporter import \
...
def __get_parquet_file_dataframe_s_terminations(
    ...
    absolute_table_name_folder_path = \
        r'C:\bWa\OXi\etl\collect\blob\blob-temp-anusha_folder-sigraph_silver_2023_05_21_1500\sigraph_silver\S_Terminations'
...
def __get_parquet_full_table_s_io_catalogue(
        ...
        output_folder_path: str):
    absolute_table_name_folder_path = \
        r'C:\bWa\OXi\etl\collect\blob\blob-temp-anusha_folder-sigraph_silver_2023_05_21_1500\sigraph_silver\S_IO_Catalogue'
...
if __name__ == '__main__':
    output_folder_path_test = \
        __get_output_folder_path(
            output_root_folder_path=r'C:\bWa\OXi\etl\sql_run_outputs')
