...
if __name__ == '__main__':
    ...
    file_configuration_list = \
        [
            ...
            [parquet_silver_scripts_root_folder_path, 'parquet', 'sigraph_silver', 'S_Connection', 'input', None, ''],
            [parquet_silver_scripts_root_folder_path, 'parquet', 'sigraph_silver', 'S_Terminals', 'input', None, ''],
            [parquet_silver_scripts_root_folder_path, 'parquet', 'sigraph_silver', 'S_Internal_Wiring', 'original_output', ['object_identifier'], ''],
    ...
    run_b_app(
        ...
        output_folder_prefix='s_internal_wiring_STN',
