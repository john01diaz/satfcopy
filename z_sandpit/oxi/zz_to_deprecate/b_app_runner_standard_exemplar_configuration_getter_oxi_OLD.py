...
def get_b_app_runner_standard_exemplar_configuration_oxi() \
    ...
    parquet_silver_root_folder_path = \
        os.path.join(
            collect_blob_folder_path,
            'blob-temp-anusha_folder-sigraph_silver_2023_04_19')
    ...
    file_configuration_list = \
        [
            ...
            # [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_CableCatalogueNumber_Master', 'original_output', ['cable_object_identifier'], None, ['catalogueno']],
            ...
            [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_DeviceCatalogue', 'original_output', None, None,
            ...
            # [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_Terminations', 'original_output',
            #  ['cablenumber',
            #   'class',
            #   'core_markings',
            #   'equipment_no',
