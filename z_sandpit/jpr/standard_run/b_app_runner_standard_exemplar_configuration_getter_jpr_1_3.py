...
def get_b_app_runner_standard_exemplar_configuration_jpr() \
    ...
    etl_processes_wrapper_configuration = \
        get_common_local_b_app_runner_standard_exemplar_configuration(
            drive_name='d',
            user_initials='JPr',
            configuration_json_relative_file_path='etl_run_configuration_io_allocation_sql_without_file_reference.json',
            output_folder_prefix='io_allocation',
            output_folder_suffix='GOLD',
