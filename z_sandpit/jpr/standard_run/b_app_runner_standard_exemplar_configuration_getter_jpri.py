...
from z_old_code.etl_processes.etl_layers.runners_v2.silver.silver_c08_s_device_catalogue_sql_01_00_runners import SilverC08DeviceCatalogueSql0100Runners
...
def get_b_app_runner_standard_exemplar_configuration_jpr() \
    ...
    parquet_bronze_root_folder_path = \
        os.path.join(
            collect_blob_folder_path,
            'blob-temp-anusha_folder-sigraph_bronze_2023_04_19')
    ...
    #     os.path.join(
    #         collect_blob_folder_path,
    #         'blob-temp-anusha_folder-sigraph_silver_2023_05_21_1500_reduced')
    ...
    HardcodedConfigurations.loop_picklist_file_path = \
        os.path.join(
            collect_blob_folder_path,
            'blob-temp-anusha_folder-sigraph_crosswalks_db_2023_04_20',
            'sigraph_crosswalks,',
    ...
    file_configuration_list = \
        [
            ...
            [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_DeviceCatalogue', 'original_output', None, '', [S_DeviceCatalogue.CATALOGUE_RNT.value, S_DeviceCatalogue.TYPE.value]],
            ...
            # # [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_Internal_Wiring', 'original_output',
            # None, None, [S_Internal_Wiring.TO_LEFT_RIGHT.value, S_Internal_Wiring.FROM_LEFT_RIGHT.value,
            ...
            # [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_Terminations', 'original_output', None, None, [S_Terminations.DATABASE_NAME.value, S_Terminations.OBJECT_IDENTIFIER.value, S_Terminations.PARENT_EQUIPMENT_NO.value]],
            # [parquet_silver_root_folder_path, 'parquet', 'sigraph_silver', 'S_Terminations', 'original_output',None, None],
            ...
            # [loader_gold_scripts_root_folder_path, 'xlsx', '6_IO_Catalogue.xlsx', 'IO_Catalogue', 'original_output', None, 'export (24)', [IO_Catalogue.TERMINALSPERMARKING.value]],
            ...
            #         Instrument_Index.DESCRIPTION.value,
            #         Instrument_Index.EFFICIENCY_AT_NOMINAL_POWER_AND_MINIMUM_ROTATIONAL_SPEED.value,
            #         Instrument_Index.EFFICIENCY_AT_NOMINAL_POWER_AND_NOMINAL_ROTATIONAL_SPEED.value,
            #         Instrument_Index.INPUT_SIGNAL_EXPLOSION_PROTECTION.value,
            #         Instrument_Index.JUNCTION_BOX.value,
            #         Instrument_Index.LOCATION_BLOCK_DEF.value
            #     ]],
            # [loader_gold_scripts_root_folder_path, 'xlsx', '9_Major_Equipments.xlsx', 'Major_Equipments', 'original_output', None, 'export (21)'],
            # [loader_gold_scripts_root_folder_path, 'xlsx', '10_Component.xlsx', 'Component', 'original_output', None, 'export (27)', [Component.EQUIPMENT_NO.value]],
    ...
    process_configuration_list = \
        [
            ...
            # GoldC04DeviceCatalogueSql0100Runners
            # GoldC07LoopIndexSql0100Runners
            # Gold08InstrumentIndexSql0100Runners
            # Gold06IOCatalogueSql0100Runners
            # Gold10ComponentSql0100Runners
            # SilverC17TerminationsSql0100Runners
