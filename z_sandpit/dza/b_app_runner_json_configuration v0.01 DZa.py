...
if __name__ == '__main__':
    ...
    etl_database_configuration_file_path = \
        os.path.join(
            configurations_folder_path,
            'process_table_configuration 2023-06-21 v0.01 AGu.db')
    ...
    run_b_app(
        ...
        etl_json_configuration_file_name='etl_run_configuration v0.06 DZa.json',
        etl_json_configuration_filtered_file_name='etl_run_configuration_filtered v0.06 DZa.json')
