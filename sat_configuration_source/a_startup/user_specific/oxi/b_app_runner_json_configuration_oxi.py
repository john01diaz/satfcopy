...
from sat_configuration_source.a_startup.user_specific.oxi.sat_configuration_b_app_runner_configuration_getter_oxi import \
    get_sat_configuration_b_app_runner_configuration_oxi
