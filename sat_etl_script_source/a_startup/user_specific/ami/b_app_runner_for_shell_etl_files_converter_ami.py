...
if __name__ == '__main__':
    ...
    path = \
        r'C:\bWa\AMi\etl\collect\ETL_Scripts_20230516\ETL_Scripts_202305161550\01_Instrumentation_ETL_Scripts'
    ...
    output_root_folder = \
        Folders(
            absolute_path_string=r'C:\bWa\AMi\etl\file_conversion_outputs')
