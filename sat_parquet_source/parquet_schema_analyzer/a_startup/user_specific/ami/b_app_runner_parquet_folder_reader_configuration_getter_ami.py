...
def get_b_app_runner_parquet_folder_reader_configuration_ami() \
        -> ParquetFolderReaderConfigurations:
    # NOTE: This folder should be the parent folder of the folder containing the parquet files
    input_root_folder = \
        Folders(
            absolute_path_string=r'C:\bWa\AMi\etl\collect\tests\silver_test')

    output_root_folder = \
        Folders(
            absolute_path_string=r'C:\bWa\AMi\etl\sat_parquet_outputs')
