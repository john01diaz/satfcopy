...
from sat_parquet_source.parquet_common.table_writers.pandas_dataframe_as_parquet_table_using_pyarrow_exporter import \
    export_pandas_dataframe_as_parquet_table_using_pyarrow
...
def reduce_pandas_dataframe_using_pyarrow(
